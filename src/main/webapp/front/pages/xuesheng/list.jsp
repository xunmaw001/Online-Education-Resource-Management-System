      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="xueshenghao" id="xueshenghao" placeholder="学生号" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xueshenghao').val()) {
          param['xueshenghao'] = jquery('#xueshenghao').val() ? '%' + jquery('#xueshenghao').val() + '%' : '';
        }  
