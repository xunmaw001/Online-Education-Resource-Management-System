...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>学时</label>
										<input id="xueshi" name="xueshi" class="form-control" placeholder="学时">
									</div>
									<div class="form-group col-md-6">
										<label>课程内容</label>
										<div>
										<div class="upload">选择文件<input name="file" type="file" class="form-control-file" id="kechengneirongupload"></div>
										<label id="kechengneirongFileName"></label>
										<input name="kechengneirong" id="kechengneirong-input" type="hidden">
										</div>
									</div>
									<div class="form-group col-md-6">
										<label>课程简介</label>
										<textarea name="kechengjianjie" class="form-control" id="kechengjianjie" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>教师工号</label>
	...
	<script>
		...
		function upload(){
			...
			$('#kechengneirongupload').fileupload({
				...
				dataType: 'json',
					...
					document.getElementById('kechengneirong-input').setAttribute('value',baseUrl+'file/download?fileName='+data.result.file);
					if(document.getElementById('kechengneirongFileName') != null){
						document.getElementById('kechengneirongFileName').innerHTML = "上传成功!";
					}		
					$("#kechengneirongImg").attr("src",data.result.file);												
				}
			});
		}  
		//取消 
		...
		function dataBind(){
			...
			$("#xueshi").val(ruleForm.xueshi);	
			$("#kechengneirong-input").val(ruleForm.kechengneirong);
			$("#kechengneirongFileName").html(ruleForm.kechengneirong);
			$("#kechengjianjie").val(ruleForm.kechengjianjie);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xueshi != null && res.data.xueshi != ''){

					$("#xueshi").val(res.data.xueshi);
					}
					if(res.data != null && res.data != '' && res.data.kechengneirong != null && res.data.kechengneirong != ''){

					$("#kechengneirong-input").val(res.data.kechengneirong);
					$('#kechengneirongFileName').val(res.data.kechengneirong)
					}
					if(res.data != null && res.data != '' && res.data.kechengjianjie != null && res.data.kechengjianjie != ''){

					$("#kechengjianjie").val(res.data.kechengjianjie);
					}
