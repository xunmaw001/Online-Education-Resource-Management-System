...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="xueshenghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										学生姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xueshenghao')">学生号<i id="xueshenghaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#xueshenghaoSearch').val() != null && $('#xueshenghaoSearch').val() != ''){
				searchForm.xueshenghao ="%" +  $('#xueshenghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xuesheng/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				xueshenghao : searchForm.xueshenghao,	
		...
		function setDataRow(item,number){
			...
			var xueshenghaoCell  = document.createElement('td');

						 xueshenghaoCell.innerHTML = item.xueshenghao;


			row.appendChild(xueshenghaoCell);
