...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>学生号</label>
										<input id="xueshenghao" name="xueshenghao" class="form-control" placeholder="学生号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#xueshenghao").val(ruleForm.xueshenghao);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xueshenghao != null && res.data.xueshenghao != ''){

					$("#xueshenghao").val(res.data.xueshenghao);
					}
